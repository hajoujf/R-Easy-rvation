...
<nav style="z-index: 1;position:fixed;width:100%;" class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <li class="nav-item">
	...
	<li class="nav-item">
        <a class="nav-link" href="../About.php">	About &nbsp<i class='far fa-question-circle'></i>
</a>
      </li>
	<?php
			if(isset($_SESSION['User'])){
				if($_SESSION['User']==null){
					echo "<li class='nav-item'><a class='active nav-link' href='../logboth.php'>Sign In &nbsp<i class='far fa-user-circle'></i></a></li>";
				}
				else{
        echo "<div class='dropdown'>";
        echo "<li class='nav-item' style='cursor:pointer'><a class='active nav-link'>".$_SESSION['User']."&nbsp<i class='far fa-user-circle'></i></a></il>";
        ...
        echo "</div>";
			...
			echo "  <li class='nav-item'><a class='nav-link active' href='logboth.php'>Sign In &nbsp<i class='far fa-user-circle'></i></a></li>";
	?>
    </ul>
  </div>
</nav>
